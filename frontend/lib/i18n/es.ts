...
export const es = {
  ...
  steps: {
    ...
    signaturesWhyNone: "la clave de sesión firma la transacción y el enclave ya te conoce en este navegador",
    signaturesWhyTwo: "una autoriza la clave de sesión, otra te identifica ante el enclave",
    signaturesWhySession: "solo falta autorizar la clave de sesión; después, ninguna",
    signaturesWhyEnclave: "solo falta identificarte ante el enclave; la clave de sesión ya está autorizada",
